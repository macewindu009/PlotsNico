mergedDir=/storage/jbod/nzaeh/NAFDYFixedTausNoCut/merged
...
#hadd -f $saveDir/DY.root DYJetsToLLM50_RunIISummer16MiniAODv2_PUMoriond17_13TeV_MINIAOD_madgraph-pythia8_ext1/*.root DYJetsToLLM50_RunIISummer16MiniAODv2_PUMoriond17_13TeV_MINIAOD_madgraph-pythia8_ext2/*.root
cd -
